...
data_int  = int(data_float) # akan dibulatkan ke bawah contoh = data_float 9.5 atau 9.9 menjadi data_int 9
...
data_int   = int(data_bool) # akan dibulatkan ke bawah contoh = data_float 9.5 atau 9.9 menjadi data_int 9
